...
# compile data
sthd_df = read_excel("C:/Git/SnakeRiverFishStatus/output/syntheses/LGR_Steelhead_all_summaries_2024-04-02.xlsx",
                     sheet = "Pop_Tot_Esc",
                     progress = F)
...
write_csv(sthd_cvs,
          file = here("output/sthd_population_cvs.csv"))
write_csv(chnk_cvs,
          file = here("output/chnk_population_cvs.csv"))
